        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeLoanAccountId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Accounts_Accounts_HomeLoanAccountId",
                        column: x => x.HomeLoanAccountId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_HomeLoanAccountId",
                table: "Accounts",
                column: "HomeLoanAccountId");
